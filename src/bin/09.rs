...
fn solve(input: &str, predict: fn(&[i32]) -> i32) -> i32 {
...
fn predict_p1(seq: &[i32]) -> i32 {
    let (_, lasts) = firsts_and_lasts(seq);
    lasts.iter().sum()
}

fn predict_p2(seq: &[i32]) -> i32 {
